...
<div class="row">
    <div class="card w-100 shadow p-3 mb-5  rounded">
        ...
        <div class="card-body h-100">
            <div class="card-header bg-info text-white text-center">Por Vendedor</div>
            <div class="row">
                <div class="col-md-4  h-100">
                    <div class="card-body border">
                        ...
                        <div class="card-footer">
                            ...
                            <button class="btn btn-info btn-md" style="margin:1px 0  0 90px">Mais</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-4  h-100">
                ...
                <div class="col-md-4  h-100">
                    <div class="card-body border">
                        <div class="card-header w-100 text-center"> Total de Vendas por mes</div>
